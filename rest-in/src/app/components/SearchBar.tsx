...
export default function SearchBar({value, onChange, onSubmit}: SearchProps) {
  return(
        ...
        <div className="relative">
            ...
            <input type="search" id="default-search"
             className="block w-full p-4 ps-10 text-sm border border-gray-300 rounded-lg bg-gray-50 
              ...
              dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Search for city..." required
              value={value}
              onChange={onChange}
              />
